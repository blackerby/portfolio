...
This site was built using the [Hugo](https://gohugo.io/) static site generator with the [Hugo Book Theme](https://github.com/alex-shpak/hugo-book). It was deployed using [GitHub Pages](https://pages.github.com/).
{{< /columns >}}
